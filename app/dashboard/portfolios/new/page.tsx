                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="space-y-3">
                            <p>
                                You've created {limitInfo?.current || 0} of {limitInfo?.limit || 0} portfolios on the <span className="font-semibold uppercase">{limitInfo?.plan || "free"}</span> plan.
                            </p>
                            <p className="text-foreground font-medium">
                                Upgrade to Pro for unlimited portfolios, 50 ATS checks/month, and 30 AI tailoring sessions!
                            </p>
